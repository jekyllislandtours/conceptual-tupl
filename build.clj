...
(defn- pom-template [version]
  [[:description "Conceptual is a fast JVM based in-memory concept database that can be used as a feature store, graph database, and more."]
   [:url "https://github.com/jekyllislandtours/conceptual-tupl"]
   [:licenses
    [:license
     [:name "MIT License"]
   ...
   [:scm
    [:url "https://github.com/jekyllislandtours/conceptual-tupl"]
    [:connection "scm:git:https://github.com/jekyllislandtours/conceptual-tupl.git"]
    [:developerConnection "scm:git:ssh:git@github.com:jekyllislandtours/conceptual-tupl.git"]
    [:tag (str "v" version)]]])
